...
class HrPayslip(models.Model):
    ...
    secondary_currency_id=fields.Many2one("res.currency", string="Secondary Currency",related="struct_id.currency_id",store=True)
...
class PayslipLine(models.Model):
    ...
    secondary_currency=fields.Boolean(string="Is Secondary Currency ?",compute="_compute_is_secondary_currency",store=True)
